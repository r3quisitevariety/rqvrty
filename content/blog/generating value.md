...
If you do that btw, all that will happen is whatever you create will be indistinguishable from everything else — a reaction channel, a clip farm, pumping out weekly content and short-form clips. You will flatten out your own [rough edges](https://www.youtube.com/watch?v=Ne3S2W4Up3Q) which makes you unique and special, in subservience of some algorithm or metric.
...
>
> TL;DR? **_DON'T BE A TECHBRO._** Simply be yourself and create content that you're passionate about; share your website proudly, host useful content and services, contribute to the community, and share knowledge and resources.

My thesis is this; given the right action and principles, *anyone* can generate value for the world that drives things forward — and this isnt necessarily correlary with money, but *it's okay*, because as [george hotz said](https://geohot.github.io/blog/jekyll/update/2026/03/11/running-69-agents.html), if you create more value than you consume, you are welcome in any well operating community. 
...
I think we vastly underestimate our own capabilities in changing things for the better. Especially in an age where doom is served to us like fast food on a silver platter. 
...
It really is more simple than it seems. After all, what is this post other than a synthesis of my life experiences, emotions, and ideals bundled into a bunch of words that I decided to sit down and write for an hour on? We can say I pulled it right out of my ass, but didn't [srinivasa ramanujan](https://en.wikipedia.org/wiki/Srinivasa_Ramanujan) do the same when creating all of his mathematical breakthroughs? 

I think the difference between something truly valuable and something that's just slop is really your intention and creative vision. That's why in tech circles recently there's been the whole "taste" argument. I define taste as once again, your [rough edges](https://www.youtube.com/watch?v=Ne3S2W4Up3Q) that make you unique — which you normally want to drown out so you can blend in with the crowd. 
